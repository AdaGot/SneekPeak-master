...
public class LevelManager : MonoBehaviour
{
    ...
    public void OnLose()
    {
        //ta funkcja jest wywoływana po porażce
        gameOverOberlay.SetActive(true);
        gameOverOverlay.transform.Find("Reason Text").GetComponent<TextMeshProUGUI>().text = "Kamera cie zobacz3ła!";
    }
}